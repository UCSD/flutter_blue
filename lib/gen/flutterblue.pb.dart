...
class AdvertisementData extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AdvertisementData', createEmptyInstance: create)
    ...
    ..pPS(6, 'serviceUuids')
    ..a<$core.List<$core.int>>(7, 'rawData', $pb.PbFieldType.OY, protoName: 'rawData')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(7)
  $core.List<$core.int> get rawData => $_getN(6);
  @$pb.TagNumber(7)
  set rawData($core.List<$core.int> v) { $_setBytes(6, v); }
  @$pb.TagNumber(7)
  $core.bool hasRawData() => $_has(6);
  @$pb.TagNumber(7)
  void clearRawData() => clearField(7);
}
